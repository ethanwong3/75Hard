...
export default function SignUpScreen2() {
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.signUp}>
        <Text>Enter 6 digit code to verify email address</Text>
      </View>


      <View style={{alignSelf: 'center', justifyContent: 'center', paddingTop: 70, paddingBottom: 145,}}>
        <BigNumberInput input="––––––"/>
      </View>
